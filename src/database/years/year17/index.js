...
const albums17 = [
  ...
  new Album(
    ...
    2017,
    "",
    "https://upload.wikimedia.org/wikipedia/en/4/41/Liam_Gallagher_-_As_You_Were.jpg",
    [],
    []
  ),
  new Album(
    ...
    2004,
    "",
    "https://upload.wikimedia.org/wikipedia/en/5/52/Franz_Ferdinand_-_Take_Me_Out.jpg",
    [],
    []
  ),
  new Album(
    ...
    2015,
    "",
    "https://e.snmc.io/i/600/s/840e239afabe338ad498d004d7e13b64/5860959/gorduratrans-repertorio-infindavel-de-dolorosas-piadas-Cover-Art.jpg",
    [],
    []
  ),
  new Album(
  ...
  new Album(
    ...
    2008,
    "",
    "https://upload.wikimedia.org/wikipedia/en/9/9d/Dig_out_your_soul.jpg",
    [],
    []
  ),
  new Album(
    ...
    1991,
    "",
    "https://upload.wikimedia.org/wikipedia/en/7/72/R.E.M._-_Losing_My_Religion.jpg",
    [],
    []
  ),
  new Album(
    ...
    1997,
    "",
    "https://upload.wikimedia.org/wikipedia/en/0/08/BeHereNowcover.jpg",
    [],
    []
  ),
];

export const year17 = new YearData("2017", "O PRIMEIRO ANO", "", albums17);
