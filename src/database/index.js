...
const testStream = [
  new Stream(
    StreamEnum.SPOTIFY,
    "1W9IHb4ld1ZtAD9rlKgiOh",
    "https://open.spotify.com/album/1W9IHb4ld1ZtAD9rlKgiOh"
  ),
  new Stream(
    StreamEnum.DEEZER,
    "6762758",
    "https://deezer.page.link/KWCDHuebLUTVbqJJA"
  ),
];
...
const differentStream = [
  new Stream(
    ...
    "https://open.spotify.com/album/7aNclGRxTysfh6z0d8671k"
  ),
];
